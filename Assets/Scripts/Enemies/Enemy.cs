...
public class Enemy : MonoBehaviour
{
    ...
    [Tooltip("El Prefab del orbe de vida que va a soltar")]
    [SerializeField] private GameObject healthOrbPrefab;
    
    [Tooltip("Probabilidad de soltar el orbe (Ej: 30 = 30% de chance)")]
    [Range(0f, 100f)]
    ...
    private void IntentarSoltarLoot()
    {
        if (healthOrbPrefab == null) return;
