...
public class PlayerController : MonoBehaviour
{
    ...
    private void Interact()
    {
        ...
        else if (currentMonument != null)
        {
            currentMonument.InteractMonument();
        }
    }
    #endregion
    ...
    public void RestoreFullHealth()
    {
        ...
        Debug.Log("¡Descansando en la banca! Vida al 100%.");
    }
    ...
    #region Monument
    private TreeMonument currentMonument;
    public void SetCurrentMonument(TreeMonument monument) => currentMonument = monument;
    public void ClearCurrentMonument() => currentMonument = null;
    #endregion
}